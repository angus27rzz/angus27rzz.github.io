...
- $D_{\text{KL}}(p \parallel q) = \mathbb{E}_q\left[ \log \frac{q}{p}\right]$
...
The references which have been used so far are {% cite Ho2020a Luo2022 %}
...
The first option consists in keeping the former expression of $\tilde{\boldsymbol{\mu}}_t$ a function of $\vx_t$ and $\vx_0$.
